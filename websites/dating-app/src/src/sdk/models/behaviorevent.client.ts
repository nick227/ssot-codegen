...
import type {
  BehaviorEventCreateDTO,
  BehaviorEventUpdateDTO,
  BehaviorEventReadDTO,
  BehaviorEventQueryDTO
} from '@/contracts/behaviorevent/index.js'
...
/**
 * BehaviorEvent SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class BehaviorEventClient extends BaseModelClient<
  BehaviorEventReadDTO,
  BehaviorEventCreateDTO,
  BehaviorEventUpdateDTO,
  BehaviorEventQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/behavior-events')
  }
