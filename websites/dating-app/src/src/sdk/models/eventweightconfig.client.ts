...
import type {
  EventWeightConfigCreateDTO,
  EventWeightConfigUpdateDTO,
  EventWeightConfigReadDTO,
  EventWeightConfigQueryDTO
} from '@/contracts/eventweightconfig/index.js'
...
/**
 * EventWeightConfig SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class EventWeightConfigClient extends BaseModelClient<
  EventWeightConfigReadDTO,
  EventWeightConfigCreateDTO,
  EventWeightConfigUpdateDTO,
  EventWeightConfigQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/event-weight-configs')
  }
