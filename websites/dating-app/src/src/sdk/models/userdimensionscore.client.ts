...
import type {
  UserDimensionScoreCreateDTO,
  UserDimensionScoreUpdateDTO,
  UserDimensionScoreReadDTO,
  UserDimensionScoreQueryDTO
} from '@/contracts/userdimensionscore/index.js'
...
/**
 * UserDimensionScore SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class UserDimensionScoreClient extends BaseModelClient<
  UserDimensionScoreReadDTO,
  UserDimensionScoreCreateDTO,
  UserDimensionScoreUpdateDTO,
  UserDimensionScoreQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/user-dimension-scores')
  }
