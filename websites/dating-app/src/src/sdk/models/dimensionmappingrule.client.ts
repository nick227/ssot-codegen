...
import type {
  DimensionMappingRuleCreateDTO,
  DimensionMappingRuleUpdateDTO,
  DimensionMappingRuleReadDTO,
  DimensionMappingRuleQueryDTO
} from '@/contracts/dimensionmappingrule/index.js'
...
/**
 * DimensionMappingRule SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class DimensionMappingRuleClient extends BaseModelClient<
  DimensionMappingRuleReadDTO,
  DimensionMappingRuleCreateDTO,
  DimensionMappingRuleUpdateDTO,
  DimensionMappingRuleQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/dimension-mapping-rules')
  }
