...
import type {
  PersonalityDimensionCreateDTO,
  PersonalityDimensionUpdateDTO,
  PersonalityDimensionReadDTO,
  PersonalityDimensionQueryDTO
} from '@/contracts/personalitydimension/index.js'
...
/**
 * PersonalityDimension SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class PersonalityDimensionClient extends BaseModelClient<
  PersonalityDimensionReadDTO,
  PersonalityDimensionCreateDTO,
  PersonalityDimensionUpdateDTO,
  PersonalityDimensionQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/personality-dimensions')
  }
