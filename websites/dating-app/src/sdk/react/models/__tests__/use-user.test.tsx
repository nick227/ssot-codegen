// @generated
// Automated tests for User React hooks
...
describe('User React Hooks', () => {
  ...
  describe('useUser', () => {
    it('should fetch single user by ID', async () => {
      const mockUser = { id: 'test-123', title: 'Test User' }
      mockAPI.get.mockResolvedValue(mockUser)
      
      const { result } = renderHook(() => useUser('test-123'), {
  ...
  describe('useUsers', () => {
    it('should fetch list of users', async () => {
      ...
      const { result } = renderHook(() => useUsers({ take: 20 }), {
        wrapper: createWrapper()
      })
  ...
  describe('useInfiniteUsers', () => {
    it('should fetch pages of users', async () => {
      const mockPage = {
  ...
  describe('useCreateUser', () => {
    it('should create user', async () => {
      const newData = { title: 'New User', content: 'Test content' }
      const createdUser = { id: 'test-123', ...newData }
      mockAPI.create.mockResolvedValue(createdUser)
  ...
  describe('useUpdateUser', () => {
    it('should update user', async () => {
      const updatedUser = { id: 'test-123', title: 'Updated' }
      mockAPI.update.mockResolvedValue(updatedUser)
