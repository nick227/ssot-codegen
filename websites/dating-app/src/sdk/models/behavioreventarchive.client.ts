...
import type {
  BehaviorEventArchiveCreateDTO,
  BehaviorEventArchiveUpdateDTO,
  BehaviorEventArchiveReadDTO,
  BehaviorEventArchiveQueryDTO
} from '@/contracts/behavioreventarchive/index.js'
...
/**
 * BehaviorEventArchive SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class BehaviorEventArchiveClient extends BaseModelClient<
  BehaviorEventArchiveReadDTO,
  BehaviorEventArchiveCreateDTO,
  BehaviorEventArchiveUpdateDTO,
  BehaviorEventArchiveQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/behavior-event-archives')
  }
