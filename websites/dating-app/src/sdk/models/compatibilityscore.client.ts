...
import type {
  CompatibilityScoreCreateDTO,
  CompatibilityScoreUpdateDTO,
  CompatibilityScoreReadDTO,
  CompatibilityScoreQueryDTO
} from '@/contracts/compatibilityscore/index.js'
...
/**
 * CompatibilityScore SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class CompatibilityScoreClient extends BaseModelClient<
  CompatibilityScoreReadDTO,
  CompatibilityScoreCreateDTO,
  CompatibilityScoreUpdateDTO,
  CompatibilityScoreQueryDTO
> {
  constructor(client: BaseAPIClient) {
    super(client, '/api/compatibility-scores')
  }
