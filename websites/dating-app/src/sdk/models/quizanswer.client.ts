...
import type {
  ...
  QuizAnswerReadDTO,
  QuizAnswerQueryDTO
} from '@/contracts/quizanswer/index.js'
...
/**
 * QuizAnswer SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class QuizAnswerClient extends BaseModelClient<
  QuizAnswerReadDTO,
  QuizAnswerCreateDTO,
  QuizAnswerUpdateDTO,
  QuizAnswerQueryDTO
