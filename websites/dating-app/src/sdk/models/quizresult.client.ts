...
import type {
  ...
  QuizResultReadDTO,
  QuizResultQueryDTO
} from '@/contracts/quizresult/index.js'
...
/**
 * QuizResult SDK Client - Thin Facade Pattern
 * 
 ...
 * ```
 */
export class QuizResultClient extends BaseModelClient<
  QuizResultReadDTO,
  QuizResultCreateDTO,
  QuizResultUpdateDTO,
  QuizResultQueryDTO
