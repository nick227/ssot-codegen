...
import { dimensionMappingRuleService as baseService } from '@/services/dimension-mapping-rule'
...
export const adminConfigServiceService = {
   ...
   */
  async createRule(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async updateRule(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async deleteRule(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async bulkUpdateRules(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async getRuleHistory(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async createEventWeight(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async updateEventWeight(userId: number, ...args: any[]) {
    try {
   ...
   * This is where you write your orchestration code.
   */
  async getConfigStatus(userId: number, ...args: any[]) {
    try {
