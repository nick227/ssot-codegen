...
// Re-export provider and React Query utilities
export { SDKProvider, defaultQueryClient } from './provider'
...
/**
 * SDK Provider - Wraps app with React Query
 * 
 * @example
 * \`\`\`typescript
