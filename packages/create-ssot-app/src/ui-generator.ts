...
export async function generateUI(projectPath: string, config: ProjectConfig, models: ParsedModel[], mappings?: any): Promise<void> {
  ...
  switch (config.uiTemplate) {
    ...
    case 'dashboard':
      // Not implemented yet
      console.log(`\n⚠️  ${config.uiTemplate} template coming soon`)
      break
  }
}
  ...
  return (
    <div className="p-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          <h2 className="text-xl font-semibold mb-2">📝 ${model.name}s</h2>
      ...
      <div className="mt-12 p-6 bg-blue-50 border border-blue-200 rounded-lg">
        <h3 className="font-semibold mb-2">🎨 Generated UI</h3>
 ...
 * 
 * ✨ SAFE TO EDIT - Customize columns, filters, and behavior
 * 🔄 To regenerate: pnpm ssot generate --ui
 */
 ...
 * 
 * ✨ SAFE TO EDIT - Customize layout and fields
 */
...
- ✅ Update model pages if schema changed
- ⚠️  Prompt before overwriting your customizations
- ✅ Preserve your edits in marked sections
