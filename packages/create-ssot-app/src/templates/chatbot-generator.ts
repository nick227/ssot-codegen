 ...
 * Main chat interface
 * 
 * ✨ SAFE TO EDIT - Customize chat behavior
 */
 ...
 * 
 * ✨ Uses shared components: Avatar, TimeAgo, Badge
 */
...
function generateChatInput(_messageModel: ParsedModel, _fields: any): string {
  return `/**
 * Generated by SSOT CodeGen - Chatbot Template
 ...
 * 
 * ✨ Uses shared components: Avatar, Badge
 */
